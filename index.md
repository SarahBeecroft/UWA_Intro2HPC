...
venue: "UWA"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
address: "Bayliss Building"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
...
humandate: "August 20, 2021"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:00-12:00"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
startdate: 2021-08-20      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2021-08-20        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Sarah Beecroft", "Marco de la Pierre"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
